...
const Sidebar = ({ onClick, hidden, isMobile, toggle }: {
    ...
    return (
        <div className={`flex flex-col ${hidden ? 'w-0 overflow-auto' : 'w-full md:w-[300px] px-3 py-4'} md:z-0 h-screen md:overflow-y-auto bg-teal-900 dark:bg-gray-800 transition-all duration-1000`}>
            <div className="mb-1 flex flex-row gap-2">
                ...
                <span className="" data-state="closed">
                    <a className="flex p-3 gap-3 transition-colors duration-200 text-white cursor-pointer rounded-md border border-white/20 hover:bg-gray-500/10 h-16 md:h-11 w-16 md:w-11 flex-shrink-0 items-center justify-center" onClick={onClick}>
            ...
            <ul className="space-y-2 font-medium">
                <SidebarElement text="Home" href="/" toggle={toggle} isMobile={isMobile} />
                <SidebarElement text="About Me" href="/about" toggle={toggle} isMobile={isMobile}/>
                <SidebarElement text="Experience" href="/experience" toggle={toggle} isMobile={isMobile}/>
                <SidebarElement text="Projects" href="/projects" toggle={toggle} isMobile={isMobile}/>
            </ul>
            <div className="flex-grow" />
            <div className="mb-1 flex flex-row gap-4 md:gap-2 justify-center">
