        ...
        <Home>
            <Response question={Q}>
                <p>
                    ...
                    <br/><br/> 
                    <Typewriter text={A[1]} typeDelay={5} startDelay={4000} />
                    <br/><br/> 
                    <Typewriter text={A[2]} typeDelay={5} startDelay={8000} />
                    <br/><br/> 
                    <Typewriter text={A[3]} typeDelay={5} startDelay={12000} />
                    <br/><br/> 
                    <Typewriter text={A[4]} typeDelay={5} startDelay={16000}/>
                    <br/><br/> 
                    <Typewriter text={A[5]} typeDelay={5} startDelay={20000}/>
                </p>
            </Response>
