...
const Sidebar: React.FC = () => {
    return (
        <div className="flex flex-col w-64 h-screen px-3 py-4 overflow-y-auto bg-teal-900 dark:bg-gray-800">
            <div className="mb-1 flex flex-row gap-2">
                ...
                <span className="" data-state="closed">
                    <a className="flex p-3 gap-3 transition-colors duration-200 text-white cursor-pointer rounded-md border border-white/20 hover:bg-gray-500/10 h-11 w-11 flex-shrink-0 items-center justify-center">
            ...
            <ul className="space-y-2 font-medium">
                ...
                <SidebarElement text="About Me" href="#" />
