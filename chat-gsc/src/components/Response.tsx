    ...
    return (
        <div ref={dummyRef} className="overflow-y-scroll text-neutral-600">
            <div className={`w-full border-b flex flex-row ${questionFinished ? null : "invisible"}`}>
                <div className="ml-5 mr-5 md:ml-16 md:mr-10 mt-10 mb-10">
                ...
                <div className="mr-5 md:mr-24 mt-10 mb-10 flex items-center text-sm">
                   {question}
                </div>
            </div>
            <div className={`w-full border-b flex flex-row bg-gray-100 ${questionPosted ? null : "invisible"}`}>
                ...
                <div className="mr-5 md:mr-36 mt-10 mb-10 flex flex-col items-center text-sm">
                    {children}
                </div>
            </div>
        </div>
