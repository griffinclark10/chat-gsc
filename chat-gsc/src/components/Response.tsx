...
const Response = ({ question, answer }: { question: string; answer: string[]; }) => {
    ...
    useEffect(() => {
        if (containerRef.current && lastTypewriterRef.current) {
            lastTypewriterRef.current.scrollIntoView({
                behavior: 'smooth',
                block: 'end'
            });
        }
    ...
    return (
        <div ref={containerRef} className="pt-10 overflow-y-scroll">
            <div className=" w-full border-b border-t flex flex-row">
            ...
            <div className=" w-full border-b flex flex-row">
                ...
                <div className="mr-24 mt-10 mb-10 flex flex-col items-center">
                    <p>
                        <Typewriter text={answer[0]} typeDelay={5} />
                        <br/><br/> 
                        <Typewriter text={answer[1]} typeDelay={5} startDelay={4000} />
                        <br/><br/> 
                        <Typewriter text={answer[2]} typeDelay={5} startDelay={8000} />
                        <br/><br/> 
                        <Typewriter text={answer[3]} typeDelay={5} startDelay={12000} />
                        <br/><br/> 
                        <span ref={lastTypewriterRef}>
                            <Typewriter text={answer[4]} typeDelay={5} startDelay={16000}/>
                        </span>
                        <br/><br/> 
                        <span ref={lastTypewriterRef}>
                            <Typewriter text={answer[5]} typeDelay={5} startDelay={20000}/>
                        </span>
                    </p>
                </div>
            </div>
