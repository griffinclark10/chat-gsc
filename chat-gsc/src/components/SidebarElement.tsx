...
const SidebarElement: React.FC<SidebarElementProps> = ({ text, href }) => {
    ...
    return (
        <li>
            <Link href={href} className={`flex items-center p-2 text-gray-100 rounded-lg dark:text-white hover:bg-teal-800 ${router == href ? "bg-teal-800" : null} dark:hover:bg-gray-700 group`}>
